...
class EditFileDialog(
    ...
    companion object {
        private const val FRAGMENT_TAG = "EditFileDialog"

        fun show(fragmentManager: FragmentManager, file: File, requestKey: String): EditFileDialog {
            val dialog = EditFileDialog(file, requestKey)

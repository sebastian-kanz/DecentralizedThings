...
import eth.sebastiankanz.decentralizedthings.base.databinding.LayoutFileInfoDialogBinding
import eth.sebastiankanz.decentralizedthings.base.features.filestorage.model.File
import kotlinx.serialization.json.Json

class FileInfoBottomSheet(
    private val file: File,
    private val requestKey: String
) : BottomSheetDialogFragment() {
    private var _binding: LayoutFileInfoDialogBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = LayoutFileInfoDialogBinding.inflate(inflater, container, false)
    ...
    companion object {
        private const val FRAGMENT_TAG = "FileInfoBottomSheet"

        fun show(fragmentManager: FragmentManager, file: File, requestKey: String): FileInfoBottomSheet {
            val dialog = FileInfoBottomSheet(file, requestKey)
